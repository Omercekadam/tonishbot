...
```bash
cd /home
git clone https://Omercekadam:github_pat_11BKK2JSA0LdComtJkkSYf_sfTNt2eW3MnybDUsCUZ0LSiZRVEU6juAGLdEhC49SsHM3AKXH7iKNQiVCl@github.com/Omercekadam/tonishbot.git
cd tonishbot
```
